<%@ Page Title="Deshler Lanes - Site Map" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Site_Map.aspx.cs" Inherits="Site_Map" %>
...
<ul>
    ...
    <li><a href="../Pages/High_School_Bowling.aspx">High School Bowling</a>
        <ul><li><a href="../Pages/High_School_Bowling_Scores.aspx">High School Bowling - Standings & Scores</a></li> </ul>
    </li>
